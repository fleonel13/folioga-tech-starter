...
const problems = [
  {
    title: "Écran cassé",
    description: "Écran fissuré, noir, tactile qui ne répond plus.",
    icon: "📱",
  },
  {
    title: "Batterie",
  ...
  {
    title: "Caméra",
    description: "Caméra floue, cassée ou qui ne fonctionne plus.",
    icon: "📷",
  },
  {
    title: "Connecteur",
    description: "Problème de charge ou connecteur endommagé.",
    icon: "🔌",
  },
  {
    title: "Logiciel",
    description: "Téléphone bloqué, lent ou problème de système.",
    icon: "⚙️",
  },
  {
      ...
      <section className="bg-slate-950 py-16 text-white">
        <div className="page-container">
          ...
          <div className="mt-8 max-w-3xl">
            <div className="badge-primary">📱 Réparation smartphone</div>

            <h1 className="mt-5 text-4xl font-black md:text-6xl">
              Quel est le problème avec votre smartphone ?
            </h1>
